...
# 使用示例
log_file_path = 'D:\\bishe_code\\LLM4EMD\\outputs_new\\Triangle_results_18.log'  # 替换为你的日志文件路径
output_file_path = 'D:\\bishe_code\LLM4EMD\\result_output_new\\Triangle_results_18'  # 替换为输出文件路径
