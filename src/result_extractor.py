...
# 使用示例
log_file_path = 'D:\\bishe_code\\LLM4EMD\\outputs\\Triangle_results.log'  # 替换为你的日志文件路径
output_file_path = 'D:\\bishe_code\LLM4EMD\\result_output\Triangle_results'  # 替换为输出文件路径
